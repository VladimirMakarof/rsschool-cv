...
const i18Obj = {
    ...
    'ru': {
        ...
        'about_me_text-1': 'Я закончил курс профессиональной переподготовки по специальности информационные системы и технологии в Университете ИТМО. Так же в настоящее время я успешно закончил первую ступень epam The Rolling Scopes School (stage 0) в настоящее время я ожидаю продолжение учебного процесса. Я хочу стать разработчиком полного стека.',
        'about_me_text-2': 'Поскольку я только в начале своего пути, в настоящее время у меня нет большого опыта, но я набираюсь опыта в нескольких образовательных проектах. Я люблю учиться и учиться самостоятельно, и в настоящее время я учусь онлайн, чтобы достичь своей цели - стать профессиональным разработчиком.',
        ...
        'purposes-text': 'Я стремлюсь к творческой, востребованной и прибыльной работе. Работа программиста отвечает всем этим целям. Сталкиваться с различного рода задачами и находить для них элегантные решения, позволяет самоутвердиться, а финансовая независимость - огромный плюс.',
